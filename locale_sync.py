# Simple script to sync en-US.ftl to other locales for easier locale development
# Must be ran after updates to en-US.ftl
import os

LOCALE_DIRECTORY = "./locales"
MAIN_LOCALE_FILE = "en-US.ftl"
...
for file in os.listdir(LOCALE_DIRECTORY):
    if file != MAIN_LOCALE_FILE:
        try:
            ...
            diff = set(refrence_messages) - set(
                new_messages
            )  # Subtract the new messages from the refrence messages
